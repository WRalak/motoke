  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Find Dealers</h1>
          <p className="text-gray-600">Connect with trusted vehicle dealers in your area</p>
        </div>
        ...
        <div className="mt-16 bg-blue-600 rounded-lg p-8 text-center text-white">
          <h2 className="text-2xl font-bold mb-4">Are you a dealer?</h2>
          <p className="mb-6">Join our platform and reach thousands of potential buyers</p>
